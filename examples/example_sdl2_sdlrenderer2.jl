...
module Editor
    ...
    const SDL2 = GameOne.SimpleDirectMediaLayer
    ...
    function run()
        ...
        GameOne.ImGui_ImplSDL2_InitForSDLRenderer(window, renderer)
        GameOne.ImGui_ImplSDLRenderer2_Init(renderer)
            ...
            try
                while !quit
                    ...
                    while Bool(SDL2.SDL_PollEvent(event_ref))
                        evt = event_ref[]
                        GameOne.ImGui_ImplSDL2_ProcessEvent(evt)
                        evt_ty = evt.type
                    ...
                    #     // start imgui frame
                    GameOne.ImGui_ImplSDLRenderer2_NewFrame()
                    GameOne.ImGui_ImplSDL2_NewFrame();
                    CImGui.NewFrame()
                    ...
                    GameOne.ImGui_ImplSDLRenderer2_RenderDrawData(CImGui.GetDrawData(), step);
                ...
                GameOne.ImGui_ImplSDLRenderer2_Shutdown();
                GameOne.ImGui_ImplSDL2_Shutdown();
