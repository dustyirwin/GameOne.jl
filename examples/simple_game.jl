...
function imgui(g::GameOne.Game)
    ...
    if CImGui.Begin("Sprite Animation")
        ...
        CImGui.ImText("Current Frame: $(sprite_anim.current_frame)")
        CImGui.ImText("Timer: $(round(sprite_anim.timer, digits=2))")
        CImGui.ImText("Frame Delay: $(sprite_anim.frame_times[1])")
        CImGui.ImText("Looping: $(sprite_anim.looping)")
    end
    CImGui.End()
end
